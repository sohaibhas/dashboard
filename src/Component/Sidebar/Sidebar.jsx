...
const Sidebar = () => {
  ...
  return (
    <>
      <nav className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-gradient-to-r from-gray-200 via-gray-400 to-gray-600 opacity-100 flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6 ">
