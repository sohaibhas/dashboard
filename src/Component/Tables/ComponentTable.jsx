            ...
            <tbody>
              <tr>
                <th className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left flex items-center">
                  <span className="border-t-0 px-2 align-middle border-l-0 border-r-0 text-lg whitespace-nowrap p-4">
                    Argon Design System
                  </span>
                </th>
              ...
              <tr>
                <th className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left flex items-center">
                  <span
                    className="border-t-0 px-2 align-middle border-l-0 border-r-0 text-lg whitespace-nowrap p-4"
                  >
              ...
              <tr>
                <th className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left flex items-center">
                  <span
                    className="border-t-0 px-2 align-middle border-l-0 border-r-0 text-gl whitespace-nowrap p-4"
                  >
