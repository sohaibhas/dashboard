    ...
    <div className="h-screen md:flex">
      <div className="relative overflow-hidden md:flex w-1/2 bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-sky-400 to-indigo-900 i justify-around items-center hidden">
        <div>
          ...
          <p className="text-white mt-1">
            Build Intuitive Apps that your Coustomer will love
          </p>
        </div>
      ...
      <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
        <form className="bg-white">
          ...
          <Link
            className="block w-full text-center bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2"
            to="/admin"
          >
            Login
          </Link>
